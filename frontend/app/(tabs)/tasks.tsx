...
import { View, Text, TouchableOpacity, StyleSheet, FlatList, ActivityIndicator, Alert, Switch, Animated, Pressable } from 'react-native';
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: colors.background }]} edges={['top']}>
      ...
      <View style={styles.header}>
        <View>
          <Text style={[styles.title, { color: colors.textPrimary }]}>
            {activeTab === 'tasks' ? 'Daily Tasks' : 'Reminders'}
          </Text>
          <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
            {activeTab === 'tasks' 
              ? (totalTasks > 0 ? `${completedCount} of ${totalTasks} complete` : 'Build your daily routine')
      ...
      <View style={[styles.tabContainer, { backgroundColor: colors.surfaceHighlight }]}>
        ...
        >
          ...
          <Text style={[
            styles.tabText,
            { color: activeTab === 'reminders' ? colors.textPrimary : colors.textTertiary }
          ]}>
            Reminders
          </Text>
          {reminders.length > 0 && (
