...
const s = StyleSheet.create({
  ...
  monthName:  { fontFamily: 'BarlowCondensed_700Bold', fontSize: fontSize.lg, letterSpacing: 1 },
  monthSub:   { fontFamily: 'Inter_500Medium', fontSize: fontSize.xxs, marginTop: 2 },

  dowRow:  { flexDirection: 'row', marginBottom: spacing.xs },
  dowLabel:{ fontFamily: 'Inter_600SemiBold', fontSize: fontSize.xxs, textAlign: 'center' },

  week: { flexDirection: 'row' },
  cell: { height: 44, alignItems: 'center', justifyContent: 'center', position: 'relative' },
  ...
  legendLabel: { fontFamily: 'Inter_500Medium', fontSize: fontSize.xxs },

  detailCard: { borderRadius: radius.lg, borderWidth: 1, padding: spacing.lg, marginBottom: spacing.lg },
  detailDate: { fontFamily: 'Inter_600SemiBold', fontSize: fontSize.xxs, letterSpacing: 1, marginBottom: spacing.md },
  ...
  detailBar:   { width: 72, height: 5, borderRadius: 2.5, overflow: 'hidden' },
  detailBarFill:{ height: '100%', borderRadius: 2.5, minWidth: 1 },
  detailCount: { fontFamily: 'Inter_600SemiBold', fontSize: fontSize.xs, width: 32, textAlign: 'right' },
